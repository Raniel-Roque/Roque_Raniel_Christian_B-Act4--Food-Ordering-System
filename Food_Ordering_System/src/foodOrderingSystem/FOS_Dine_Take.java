...
public class FOS_Dine_Take extends JFrame implements ActionListener{
	...
	void FOS_Dine_Take_Design(){
		JLabel BG = new JLabel(new ImageIcon(new ImageIcon("Images/Templates/Dine_Take.png").getImage().getScaledInstance(500, 600, Image.SCALE_SMOOTH)));
		...
		Dine.setFont(new Font("SansSerif", Font.BOLD, 25));
		...
		Take.setFont(new Font("SansSerif", Font.BOLD, 25));
